...
public class CassandraClientAdapter extends TransactionalModelAdapter<Client> implements ClientModel {
    ...
    public String getAuthenticationFlowBindingOverride(String binding) {
        Map<String, String> authenticationFlowBindingOverride =
    ...
    public void addClientScopes(Set<ClientScopeModel> clientScopes, boolean defaultScope) {
        ...
        clientScopeIds.putAll(
                clientScopes.stream().collect(Collectors.toMap(ClientScopeModel::getId, e -> defaultScope)));
    ...
    public Map<String, ClientScopeModel> getClientScopes(boolean defaultScope) {
        ...
        return result.stream().collect(Collectors.toMap(ClientScopeModel::getName, Function.identity()));
    }
