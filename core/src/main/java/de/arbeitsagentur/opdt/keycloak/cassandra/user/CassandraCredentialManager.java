...
public class CassandraCredentialManager implements SubjectCredentialManager {
    ...
    public CredentialModel createStoredCredential(CredentialModel cred) {
        ...
        int priority = credentials.isEmpty()
                ? PRIORITY_DIFFERENCE
    ...
    public boolean removeStoredCredentialById(String id) {
        ...
        boolean removed = userEntity
                .getCredentials()
                .remove(CredentialValue.builder().id(id).build());
    ...
    public Stream<CredentialModel> getStoredCredentialsByTypeStream(String type) {
        return getStoredCredentialsStream().filter(credential -> Objects.equals(type, credential.getType()));
    }
    ...
    public boolean isConfiguredFor(String type) {
        return getCredentialProviders(session, CredentialInputValidator.class)
                .anyMatch(validator ->
                        validator.supportsCredentialType(type) && validator.isConfiguredFor(realm, user, type));
    }
    ...
    private void validate(
            RealmModel realm, UserModel user, List<CredentialInput> toValidate, CredentialInputValidator validator) {
        toValidate.removeIf(
                input -> validator.supportsCredentialType(input.getType()) && validator.isValid(realm, user, input));
    }
