...
public class CassandraAuthSessionProvider implements AuthenticationSessionProvider {
  ...
  private Function<RootAuthenticationSession, RootAuthenticationSessionModel> entityToAdapterFunc(
    ...
    return origEntity -> {
      ...
      if (isExpired(origEntity, true)) {
        ...
        CassandraRootAuthSessionAdapter adapter =
            new CassandraRootAuthSessionAdapter(
                session, realm, origEntity, authSessionRepository, authSessionsLimit);
        session
  ...
  public RootAuthenticationSessionModel getRootAuthenticationSession(
    ...
    RootAuthenticationSession entity =
        authSessionRepository.findRootAuthSessionById(authenticationSessionId);
  ...
  public void updateNonlocalSessionAuthNotes(
    ...
    AuthenticationSession authenticationSession =
        authSessionRepository
            .findAuthSessionsByParentSessionId(compoundId.getRootSessionId())
            .stream()
