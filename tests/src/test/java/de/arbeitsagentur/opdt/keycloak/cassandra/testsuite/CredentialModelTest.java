  ...
  public void testCredentialCRUD() {
    ...
    withRealm(
        ...
        (currentSession, realm) -> {
          ...
          assertFalse(
              user.credentialManager().moveStoredCredentialTo(passwordId.get(), "not-known"));
          ...
          assertTrue(
              user.credentialManager().moveStoredCredentialTo(otp2Id.get(), passwordId.get()));
    ...
    withRealm(
        ...
        (currentSession, realm) -> {
          ...
          // Move password down
          assertTrue(
              user.credentialManager().moveStoredCredentialTo(passwordId.get(), otp1Id.get()));
