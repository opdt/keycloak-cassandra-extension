  ...
  public void testGroupUniqueness() {
    withRealm(
        ...
        (session, realm) -> {
          ...
          Assert.assertThrows(
              ModelDuplicateException.class, () -> groupProvider.createGroup(realm, "firstGroup"));
  ...
  public void testBasicCreateRemoveGroup() {
    withRealm(
        ...
        (session, realm) -> {
          ...
          GroupModel fourthGroup =
              session.groups().createGroup(realm, "fourthGroupId", "fourthGroup");
          Assert.assertEquals(
              "fourthGroup", session.groups().getGroupById(realm, "fourthGroupId").getName());
  ...
  public void testBasicGroupModel() {
    ...
    withRealm(
        ...
        (session, realm) -> {
          ...
          Assert.assertEquals("veryFirstGroup", firstGroup.getName());
          Assert.assertTrue(
              firstGroup.getAttributeStream("key2").allMatch(value -> value.contains("value2")));
  ...
  public void testGroupRoleMapping() {
    ...
    withRealm(
        ...
        (session, realm) -> {
          ...
          Assert.assertFalse(
              secondGroup.hasRole(session.roles().getRealmRole(realm, "realmRole2")));

          Assert.assertTrue(
              secondGroup.hasRole(session.roles().getClientRole(client, "clientRole2")));
          Assert.assertFalse(
              firstGroup.hasRole(session.roles().getClientRole(client, "clientRole2")));

          Assert.assertTrue(
              firstGroup.hasDirectRole(session.roles().getRealmRole(realm, "realmRole3")));
          Assert.assertFalse(
              firstGroup.hasDirectRole(session.roles().getRealmRole(realm, "realmRole2")));

          Assert.assertTrue(
              secondGroup.hasDirectRole(session.roles().getClientRole(client, "clientRole1")));
          Assert.assertFalse(
              secondGroup.hasDirectRole(session.roles().getClientRole(client, "clientRole2")));
  ...
  public void testSearchForGroupByNameStream() {
    withRealm(
        ...
        (session, realm) -> {
          ...
          Assert.assertEquals(
              3,
              session.groups().searchForGroupByNameStream(realm, "Gr", false, null, null).count());
          Assert.assertEquals(
              0,
              session.groups().searchForGroupByNameStream(realm, "Gr", true, null, null).count());

          Assert.assertEquals(
              2, session.groups().searchForGroupByNameStream(realm, "Gr", false, 1, -1).count());
          Assert.assertEquals(
              2, session.groups().searchForGroupByNameStream(realm, "Gr", false, -1, 2).count());
          Assert.assertEquals(
              1, session.groups().searchForGroupByNameStream(realm, "Gr", false, 2, 10).count());
  ...
  public void testSearchByNameWithHierarchy() {
    withRealm(
        ...
        (session, realm) -> {
          ...
          session
              .groups()
              .createGroup(realm, "subGroup", session.groups().getGroupById(realm, thirdGroupId));
        ...
        (session, realm) -> {
          ...
          Assert.assertEquals(
              ...
              session
                  .groups()
                  .getGroupsStream(
                      realm, Stream.of(firstGroupId, secondGroupId), "Group", null, null)
                  .count());
          Assert.assertEquals(
              2,
              session
          ...
          Assert.assertEquals(
              ...
              session
                  .groups()
                  .getGroupsStream(
                      realm, Stream.of(firstGroupId, secondGroupId), "first", null, null)
                  .count());
          ...
          Assert.assertEquals(
              ...
              session
                  ...
                  .getGroupsStream(
                      realm,
                      Stream.of(firstGroupId, secondGroupId, thirdGroupId),
                      "Group",
                      null,
                      null)
                  .count());
  ...
  public void testGetGroupsCount() {
    withRealm(
        ...
        (session, realm) -> {
          ...
          Assert.assertEquals(
              3, session.groups().getGroupsCountByNameContaining(realm, "Group"), 0);
          Assert.assertEquals(
              3, session.groups().getGroupsCountByNameContaining(realm, "group"), 0);
          Assert.assertEquals(
              1, session.groups().getGroupsCountByNameContaining(realm, "first"), 0);
  ...
  public void testGetTopLevelGroupsStream() {
    ...
    withRealm(
        ...
        (session, realm) -> {
          ...
          session
              .groups()
              .addTopLevelGroup(realm, session.groups().getGroupById(realm, thirdGroupId));
          return null;
        });
    ...
    withRealm(
        ...
        (session, realm) -> {
          ...
          Assert.assertEquals(
              3, session.groups().getTopLevelGroupsStream(realm, null, null).count());
    ...
    withRealm(
        ...
        (session, realm) -> {
          ...
          groups =
              session
                  .groups()
                  .getGroupsByRoleStream(realm, role1, -1, 2)
                  .collect(Collectors.toList());
          ;
          ...
          groups =
              session
                  .groups()
                  .getGroupsByRoleStream(realm, role1, 1, -1)
                  .collect(Collectors.toList());
          ;
          Assert.assertEquals(2, groups.size());
          ...
          groups =
              session
                  .groups()
                  .getGroupsByRoleStream(realm, role1, 2, 10)
                  .collect(Collectors.toList());
          ;
